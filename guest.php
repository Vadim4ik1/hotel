...
<nav class="navbar navbar-expand-lg navbar-light bg-primary  ">
  ...
  <!-- Navbar content -->
	...
	<table class="table table-bordered" >
		...
		<?php
		$staff = mysqli_query($connect, "SELECT * FROM `guest` ");
			...
			<td>
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
						<!-- <li><a href="staff/delete.php?id=<?= $st[0]?>" class="dropdown-item">Удалить</a></li> -->
						<li><a href="redact_guest.php?id=<?= $st[0]?>" class="dropdown-item">Редактировать</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="guest/banned_guest.php" method="post" enctype="multipart/form-data">
			 <div class="form-group">
              <!-- <input type="text" name="login" class="form-control px-3 py-3" placeholder="Кратко опишите причину"> -->
              <label for=""> Гость : <?= $st[1] ?></label>
             <input type="hidden" name="id_guest" class="form-control px-3 py-3" value="<?= $st[0]?>">

            </div>    

  <div class="form-group">
              <input type="text" name="why" class="form-control px-3 py-3" placeholder="Кратко опишите причину">
            </div>
              <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Перенести в черный список</button>
        </form>
      </div>
    </div>
  </div>
