...
<div class="mx-auto h1" style="width: 200px;">
  ...
  <table class="table table-bordered" >
    ...
    $date=date("Y-m-d");
// echo($date);
    $staff = mysqli_query($connect, "SELECT * FROM `nomera_bron` WHERE `status`='Подтверждено' AND '$date'=`date_in` OR '$date'>`date_in` AND '$date'<`date_out` AND `status`='Подтверждено' ");
  ...
  //     endif;
    ...
    <tr>
      ...
      <td class="<?=$color?>"><?= $st[10] ?></td>
        ...
        <input type="hidden" name="date_out" class="form-control px-3 py-3" value="<?= $st[3]?>">
      ...
      <td>
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
            ...
            <li><input type="submit" class="dropdown-item" data-bs-toggle="modal" value="Заселить" data-bs-target="#exampleModal<?= $st[0]?>"></li>
