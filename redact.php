...
<div class="modal-dialog">
 ...
 <form class="card card-block m-x-auto bg-faded form-width "action="staff/update.php" method="post" enctype="multipart/form-data">
 <legend class="m-b-1 text-xs-center">Редактирование</legend>
    <?php

  $id = $_GET['id'];
  // echo($id);
$staff = mysqli_query($connect, "SELECT * FROM `staff` WHERE `id_staff` = '$id' ");
...
?>
 ...
 <input class="form-control" id="email" type="phone" placeholder="8(919)919-91-91" name="phone" value="<?= $st[3] ?>" />
 ...
 <input class="form-control" id="password" type="text" placeholder="9123 456789" name="pass_num" value="<?= $st[2] ?>" />
  </div>
 <div class="col">
 <label for="password">Должность</label>


 <input class="form-control" id="password" type="text" placeholder="Грандмастер" name="role" value="<?= $st[4] ?>"/>
...
<div class="row"><div class="col">
 ...
 <input class="form-control" id="password" type="text" placeholder="meat23" name="login" value="<?= $st[6] ?>"/>
