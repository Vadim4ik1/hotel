...
<div class="p-x-1 p-y-3">
 <form class="card card-block m-x-auto bg-faded form-width "action="admin/signup.php" method="post" enctype="multipart/form-data">
 <legend class="m-b-1 text-xs-center">Регистрация</legend>

 <label for="first">ФИО</label>
 <input class="form-control" id="first" type="text" placeholder="Имя" name="full_name"/>
 ...
 <input class="form-control" id="email" type="phone" placeholder="8(919)919-91-91" name="phone"/>
</div>
<div class="col">
 <label for="password">Номер паспорта</label>
 <input class="form-control" id="password" type="text" placeholder="9123 456789" name="pass_num"/>
</div></div>
<div class="row"><div class="col">
 <label for="password">Должность</label>

 <input class="form-control" id="password" type="text" placeholder="Грандмастер" name="role"/>
</div><div class="col">
 <label for="password">Фото</label>

 <input class="form-control" id="password" type="file" placeholder="Фотография"  name="picture"/>
</div></div>
<div class="row"><div class="col">
 <label for="password">Логин</label>

 <input class="form-control" id="password" type="text" placeholder="meat23" name="login"/>
 ...
 <input class="btn btn-block btn-primary" type="submit" value="Регистрация">
 </div> 
