      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            ...
            <h2 class="heading">Найденные номера</h2>
          ...
          <div class="block-32">
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3 align-self-end">
                  ...
                  <p><a href=" take_bron_full.php" class="btn btn-primary btn-block" value="Поиск с фильтрами">Поиск с фильтрами</a></p>
...
// print("----------"); 
// print_r($number);
// $days = date_diff($date_in, $date_out);
$time_1 = strtotime($date_in);
$time_2 = strtotime($date_out);
...
?>
<?php
$room_n = mysqli_query($connect, "SELECT * FROM `nomera` WHERE nomer='$numbers[0]' AND `status`='free' AND `bed`='$places_bed'  ");
...
?>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              <div class="image">
                <a href="#"><img src=" <?= $room[6] ?>" alt="Image placeholder"></a>
              </div>
              <div class="text">
                ...
                <ul class="specs">
                  ...
                  <li><strong>Количество кроватей:</strong> <?= $room[9] ?></li>
                  <li><strong>Площадь:</strong> <?= $room[10] ?>m<sup>2</sup></li>
                  <li><strong>Количество комнат:</strong> <?= $room[11] ?></li>
